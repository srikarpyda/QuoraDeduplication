...
public class ClusterRankingEuclideanDistance{
	...
	public static void main(String[] args) throws IOException {
		...
		FileWriter pw = new FileWriter(new File("/Users/srikarpyda/Documents/Quora/featureExtractionEuclideanSim.csv"),true);
