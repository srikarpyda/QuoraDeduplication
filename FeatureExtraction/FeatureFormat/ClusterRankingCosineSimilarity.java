...
public class ClusterRankingCosineSimilarity{
	...
	public static void main(String[] args) throws IOException {
		...
		FileWriter pw = new FileWriter(new File("/Users/srikarpyda/Documents/Quora/featureExtractionCosineSim.csv"),true);
		...
		try {
			...
			//	System.out.println("q1 :  " + Arrays.toString(question1));
			//	System.out.println("q2 : "+ Arrays.toString(question2));
...
//System.out.println(featureSize +"feature" +vectors1.size() +"vecsizE" +vectors2.size());
	...
	public static Map<String,Integer> wordToCluster(String clusterDir){
		...
		try {
			...
			while ((str = in.readLine()) != null){
				...
				//if(i==0) System.out.println("WORD : " + word + "CLUSTER : " + cluster);
				//i++;
	...
	public static Map<String,double[]> wordToVector( String vectorDir) throws IOException{
		...
		try {
			...
			while((str = in.readLine()) != null){
				String nextLine = str;
				//if(i==0) System.out.println("line index: "+ i + " \n " + nextLine +"\n");
				//i++;
